...
public class WeaponFiles extends PluginFiles {
	...
	public static void createTemplateChargerFile() {
		 ...
		 */
			...
			file2.set("WeaponInfo.SubWeapon", "SplashBomb");
	...
	public static void AllSubWeaponReload() {
		SubWeaponData quickbomb = new SubWeaponData("QuickBomb", Material.SLIME_BALL, BombType.QuickBomb, 12, 5, 12, 40, 6);//35, 25  (直撃60?めんｄ(ry))
		SubWeaponData splashbomb = new SubWeaponData("SplashBomb", Material.TNT, BombType.SplashBomb, 36, 6, 0, 70, 20);//180, 30
		SubWeaponData suckerbomb = new SubWeaponData("SuckerBomb", Material.BREWING_STAND, BombType.SuckerBomb, 36, 6, 0, 70, 20);//180, 30
